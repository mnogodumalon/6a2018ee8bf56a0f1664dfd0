// Auto-generated. Per-entity form-enhancements config for "Issues".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["titel", "beschreibung", "repository", "status", "prioritaet", "typ", "labels", "meilenstein", "faelligkeitsdatum", {"row": ["bearbeiter_vorname", "bearbeiter_nachname"]}, {"row": ["melder_vorname", "melder_nachname"]}, "erstellt_am"],
  defaults: {
